...
import { Shield, Heart, Users, ArrowRight, Phone } from 'lucide-react';

const About: React.FC = () => {
  return (
    <section id="about" className="relative overflow-hidden">
      {/* Hero Section À propos */}
      <div className="relative py-24 bg-gradient-to-br from-slate-50 via-emerald-50 to-teal-50">
        {/* Background Pattern */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div>
                <div className="inline-flex items-center space-x-2 bg-emerald-100 text-emerald-700 px-4 py-2 rounded-full text-sm font-medium mb-6">
                  ...
                  <span>Témoignage personnel</span>
                </div>
                <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mb-6">
                  Motivation de la fondatrice
                </h2>
                <div className="w-24 h-1.5 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-full mb-8"></div>
              </div>
            ...
            <div className="relative">
              ...
              {/* Floating Card */}
              <div className="absolute -bottom-8 -left-8 bg-white p-6 rounded-2xl shadow-xl border border-emerald-100">
      ...
      {/* Section Contexte */}
      <div className="py-24 bg-slate-800 text-white relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1.5 bg-gradient-to-r from-emerald-400 to-teal-400 mx-auto rounded-full mb-8"></div>
          </div>
      ...
      <div className="py-24 bg-gradient-to-br from-white via-emerald-50 to-teal-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Contenu textuel */}
            <div className="space-y-8">
            ...
            {/* Illustration */}
            <div className="relative">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-emerald-100 to-teal-100 p-8">
                <img 
