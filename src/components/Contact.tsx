...
const Contact: React.FC = () => {
  ...
  return (
    <section
      id="contact"
      className="py-24 bg-gradient-to-br from-slate-50 via-white to-emerald-50 relative overflow-hidden"
    >
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mt-8 leading-relaxed">
            Nous sommes là pour vous écouter et vous accompagner. N'hésitez pas
            à nous contacter, votre sécurité et votre bien-être sont notre
            priorité.
          </p>
        </div>
              ...
              {contactMethods.map((method, index) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div
                      className={`w-14 h-14 bg-gradient-to-r ${method.color} rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg`}
                    >
