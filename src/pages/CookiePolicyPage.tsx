...
const CookiePolicyPage: React.FC = () => {
  const { preferences, resetConsent } = useCookieConsent();
  ...
  const cookieTypes = [
    {
      ...
      description:
        "Ces cookies sont essentiels au fonctionnement du site web et ne peuvent pas être désactivés dans nos systèmes.",
      examples: [
    ...
    },
    {
      ...
      description:
        "Ces cookies permettent au site web de fournir des fonctionnalités et une personnalisation améliorées.",
      examples: [
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-slate-600 leading-relaxed mb-8">
              ...
              tablette ou smartphone lorsque vous visitez un site web. Les
              cookies nous permettent de reconnaître votre appareil et de
              stocker certaines informations sur vos préférences ou actions
              passées.
            </p>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-8 border border-emerald-100 mb-12">
              ...
              <p className="text-slate-700 leading-relaxed">
                Nous respectons votre vie privée et nous nous engageons à être
                transparents sur l'utilisation des cookies. Vous avez le
                contrôle total sur les cookies que vous acceptez, à l'exception
                de ceux strictement nécessaires au fonctionnement du site.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Voici les différents types de cookies que nous utilisons et leur
              finalité
            </p>
          </div>
          ...
          <div className="space-y-8">
            {cookieTypes.map((type, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`bg-gradient-to-br ${type.bgColor} rounded-3xl p-8 border border-white/50 shadow-lg`}
                >
                  <div className="flex items-start space-x-6">
                    <div
                      className={`w-16 h-16 bg-gradient-to-r ${type.color} rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg`}
                    >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                ...
                >
                  ...
                  <span className="text-sm">
                    {preferences.functional ? "Activés" : "Désactivés"}
                  </span>
                </div>
                <div
                  className={`p-4 rounded-xl ${
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-slate-800">
                Contrôle depuis votre navigateur
              </h3>
            </div>
            ...
            <ul className="space-y-2 text-slate-600">
              <li className="flex items-start space-x-2">
                ...
                <span className="text-sm">
                  Bloquer tous les cookies dans les paramètres de votre
                  navigateur
                </span>
              </li>
              <li className="flex items-start space-x-2">
              ...
              <li className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-sm">
                  Configurer des exceptions pour certains sites
                </span>
              </li>
            </ul>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-emerald-500 to-teal-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            N'hésitez pas à nous contacter pour toute question concernant notre
            politique des cookies
          </p>
          <a
            href="/contact"
