...
import { UserCheck, Compass, Users, Calendar, ExternalLink, ArrowRight, Phone, Heart, Shield, BookOpen } from 'lucide-react';
...
const ActionsPage: React.FC = () => {
  const actions = [
    {
      ...
      description: 'Notre centre de ressources est votre destination unique pour obtenir des informations précieuses et un soutien en matière de prévention de la violence et de rétablissement. Vous y trouverez une multitude de ressources, notamment des articles, des guides et les coordonnées des services locaux.',
      details: [
    ...
    },
    {
      icon: Users,
      title: 'Réunions',
      description: 'Nos réunions sont des espaces d\'échange et de réflexion pour renforcer les compétences nécessaires à une communauté plus sûre et respectueuse. Nous y abordons des thèmes essentiels comme la communication, la gestion des conflits et la résilience émotionnelle.',
      details: [
    ...
    },
    {
      ...
      description: 'Le guide personnalisé est un accompagnement sur mesure pour vous aider à surmonter les conflits et à retrouver un équilibre. Nos spécialistes qualifiés vous guident à travers des échanges constructifs, en vous aidant à exprimer vos émotions, à écouter et à comprendre les autres.',
      details: [
  ...
  const resources = [
    ...
    },
    {
      ...
      description: 'Association féministe de solidarité et d\'éducation populaire'
    },
    {
      name: 'App-Elles',
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              >
                ...
                <div className={`space-y-6 ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <h3 className="text-3xl font-bold text-slate-800">{action.title}</h3>
                  </div>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-emerald-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-800 mb-6">Groupes de parole</h2>
          ...
          <div className="space-y-16">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <p className="text-lg text-slate-600 leading-relaxed">
                  Les groupes de parole occupent une place essentielle au sein de notre 
                  association dédiée à la lutte contre les violences conjugales. Ils constituent 
                  un espace d'écoute, de partage et de soutien, où chaque participant peut 
                  exprimer ses émotions, son vécu et ses interrogations en toute sécurité et 
                  sans jugement.
                </p>
              </div>
            ...
            <div className="bg-white rounded-3xl p-12 shadow-xl border border-slate-100">
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                Nos groupes de parole sont animés par des professionnels formés à 
                l'écoute et à l'accompagnement des victimes de violence. La confidentialité 
                est une priorité absolue, garantissant à chacune la possibilité de s'exprimer 
                librement, sans crainte de répercussions. Cet environnement respectueux 
                favorise la libération de la parole et contribue à la reconstruction des 
                personnes touchées.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6 lg:order-1">
                ...
                <p className="text-lg text-slate-600 leading-relaxed">
                  Les violences conjugales enferment souvent les victimes dans un 
                  isolement profond, les privant de soutien et d'échanges bienveillants. Les 
                  groupes de parole permettent de créer du lien, d'échanger avec d'autres 
                  personnes ayant vécu des expériences similaires, et ainsi de briser le 
                  silence imposé par la violence.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl p-12 shadow-xl border border-emerald-100">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-slate-600 leading-relaxed">
                    L'écoute et le partage d'expériences favorisent une prise de conscience 
                    collective et individuelle. Chacune peut apprendre des autres, se 
                    reconnaître dans certains témoignages et se sentir comprise. Ce soutien 
                    mutuel renforce la confiance en soi et encourage à entreprendre les 
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-lg text-slate-600 leading-relaxed">
                  Les groupes de parole ne se limitent pas à l'expression des souffrances ; ils 
                  visent aussi à proposer des pistes de reconstruction et de réinsertion. 
                  Grâce aux échanges et aux conseils prodigués, les participants peuvent 
                  accéder à des ressources utiles, être orientés vers des professionnels 
                  spécialisés et envisager un avenir libéré de la violence.
                </p>
                <p className="text-lg text-slate-600 leading-relaxed">
                  En intégrant un groupe de parole, chaque personne retrouve une voix, une 
                  écoute bienveillante et une force collective pour avancer vers un avenir 
                  plus serein. Nous encourageons tous ceux qui en ressentent le besoin à 
                  nous rejoindre et à faire de cet espace un véritable tremplin vers la 
                  résilience et l'émancipation.
                </p>
              </div>
            ...
            <div className="text-center bg-white rounded-3xl p-12 shadow-xl border border-slate-100">
              <blockquote className="text-2xl md:text-3xl italic font-light leading-relaxed text-slate-700 mb-6">
                « Briser l'isolement, renforcer les liens et œuvrer ensemble à un avenir plus 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-800 mb-6">Centre de ressources</h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Accédez à nos ressources partenaires pour un accompagnement complet
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {resources.map((resource, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold text-slate-800 mb-3">{resource.name}</h3>
      ...
      <section className="py-16 bg-slate-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <blockquote className="text-2xl md:text-3xl italic font-light leading-relaxed mb-8">
            « Ensemble, construisons une culture de compréhension et d'entraide pour un avenir plus harmonieux et sans violence. »
          </blockquote>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl p-12 shadow-xl border border-emerald-100">
            ...
            <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto leading-relaxed">
              Vous n'êtes pas seul. Rejoignez nos groupes pour avancer ensemble vers un avenir plus serein et bienveillant. Ensemble, nous pouvons faire la différence.
            </p>
